<?php
    class Partido{
        ...
        public function coeficientePartido($indice){
            if ($indice == 0){
                return 0.5 * $this->getCantidadGolesE1() * $this->getColeccionObjEquipo()[$indice]->getCantidadJugadores();
            } else return 0.5 * $this->getCantidadGolesE2() * $this->getColeccionObjEquipo()[$indice]->getCantidadJugadores();
        }
